    ...
    internal class original
    {
        ...
        static void PlayGame(List<int> Targets, List<int> NumbersAllowed, bool TrainingGame, int MaxTarget, int MaxNumber)
        {
            ...
            while (!GameOver)
            {
                ...
                Console.Write("F to freeze, UF to unfreeze, -1 for nothing : ");
                string Freeze = Console.ReadLine();
                if (Freeze == "F")
                {
                    Console.Write("select position to freeze");
                    Freezeposition = Convert.ToInt32(Console.ReadLine());
                ...
                {
                    UpdateTargets(Targets, TrainingGame, MaxTarget, Freezeposition);
                }
            }
        ...
        static void UpdateTargets(List<int> Targets, bool TrainingGame, int MaxTarget, int Freezeposition )
        {
            int freezeNum = 0;
            if (Freezeposition > 0)
            {
                freezeNum = Targets[Freezeposition - 1];
                Targets.RemoveAt(Freezeposition - 1);
            }
            ...
            if (Freezeposition > 0)
            {
                Targets.Insert(Freezeposition - 1, freezeNum);
            }
        ...
        static void DisplayState(List<int> Targets, List<int> NumbersAllowed, int Score, int freezePosition)
        {
            DisplayTargets(Targets, freezePosition);
        ...
        static void DisplayTargets(List<int> Targets, int freezePosition)
        {
            int count = 1;
            Console.Write("|");
