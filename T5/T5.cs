...
namespace TargetClearCS
{
    internal class T5
    {
        ...
        {
            int AmountOfOperands = CountAmountOfOperands(UserInputInRPN);
        ...
        static int CountAmountOfOperands(List<string> UserInputInRPN)
        {
            int Number = 0;
            foreach (var Count in UserInputInRPN)
            {
